...
각 가수 마다 같은 피치의 음을 낼 때, **다른 배음구조를** 가지고 낸다, 이는 성대구조 차이, 발성 방식의 차이 때문이다.  이러한 **배음 구조의 차이가 음색**이라는 특징을 만들어 준다.  낮은 배음을 많이 섞는 가수의 경우 두껍고 어두운 소리가 나고, 높은 배음을 많이 썪는 가수의 경우 얇고 날카로운 소리가 난다. 이러한 차이는 실제로 가수들을 비교해보면 알 수 있다.

<img src="https://pbs.twimg.com/media/EAC2qfqU4AACa8j.jpg" width="350" 
height="450"> 
https://t1.daumcdn.net/cfile/tistory/264ACA3359438C9B20



10cm사진 황치열사진
두 가수의 음색을 비교해보면 권정렬은 가늘고 날카로운 소리가 나고, 황치열의 경우 무겁고 거친 소리가 난다. 이는 같은 음을 내더라도  권정렬은 높은 배음을 황치열은 낮음 배음을 더 많이 내기 때문이다. 
...
오토인코더는 **manifold learning**을 위해 주로 이용되며, **Nonlinear dimensionality reduction**을 수행 할 수 있다.  먼저 데이터를 **2차원**으로 줄인 뒤, k-means 알고리즘을 이용하여  data point 간의 euclidean-dist를 기반으로 **군집화** 해 볼 것이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2MjEwODM3MCwtMTgwNjY5OTk1MSwtMT
UwODUyMDU2MywxMDkyNzcyNDQxLDgzNjIzOTUxMywtNzY2MDE3
MywtMTUzMTAxMjU1NywtMTAxNDIzODgzNywyNjM0ODQ5NDYsMT
IyNTAzOTczNiwxMTYwNDA5Njk0LC04MTkzNDI5NzgsLTE0NDY4
NjY5MTUsNDI1NDQzMjU2LDE3Njc2ODkzNywtMTQ1ODY5Mzk2MS
wxOTg5MDk4NDU0LDEyMjM3NDI4MzMsLTE0MjU1MzY0MjUsLTEz
MDAyNzc0MjddfQ==
-->