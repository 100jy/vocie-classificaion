...
오토인코더는 manifold learning을 위해 주로 이용되며, **Nonlinear dimensionality reduction**을 수행 할 수 있다.  먼저 데이터를 2차원으로 줄여  data point 간의 euclidean-dist를 기반으로 군집화 해 볼 것이다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyNjMzMDY4MCwtMTI2MTU3MjA3NiwxNT
