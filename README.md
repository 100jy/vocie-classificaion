...
우선 입력 신호를 ⑴ 일정한 간격의 frame으로 나눈 뒤,  **⑵프레임 마다 Periodogram Spectral Estimate을 만든다**.  이렇게 나온 결과를 Power spectrum이라 하고 ⑶이 Power spectrum에 **Mel Filter bank**를 적용한다
***
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NjA4MzI1MjksLTM5OTcyMTk4MywzNj
